...
export default function Weather(props) {
  return (
    <div className="container city-info">
      <div className="row">
        <div className="col-md-4 city-temp">
      ...
      <div className="row dis-weather">
        <div className="col-md-4">Description:{props.data.description}</div>
        <div className="col-md-4">Humidity:{props.data.humidity}%</div>
        <div className="col-md-4">Wind: {props.data.wind} km/h</div>
      </div>
    </div>
  );
}
